...
export const displayApiError = (satusCode) => {
...
const clearDisplay = () => {
    const currentConditions =
        document - getElementById("currentForecast__conditions");
...
const createDailyForecastDivs = (dayWeather) => {
    const dayAbbreviationText = getDayAbrreviation(dayWeather.dt);
